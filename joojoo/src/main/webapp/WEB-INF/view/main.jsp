...
<body class="homepage" bgcolor=#333323>
   <div id="header-wrapper" style="background-image: images/main.jpg">
   ...
   <div id="features-wrapper" bgcolor=#333323>
      ...
      <ul>
         ...
         <li><button type="button" class="btn btn-warning btn-sm">Search</button></li>

      </ul>
      </nav> <br>
      <div class="row" bgcolor=#333323>
         <div class="4u">
            <!-- Feature -->
            <section> <a href="#" class="image featured"> <img src="images/pic01.jpg" alt="" />
            </a> <header>
            <h3>JooJooClub1</h3>
            </header>
