...
<body class="homepage" bgcolor=#333323>
	...
	<div id="features-wrapper">
		...
		<div class="row">
			...
			<!-- 바디 상점 검색 시작 -->
			<div id="accordion-resizer" class="container" align="center"
				style="background-color: gray">

				<!-- 카테고리 구분 테이블 -->
				<table width="83%" align="center" cellpadding="5" cellspacing="0"
				...
				<div id="accordion" class="container">
					...
					<c:forEach items="${stores}" var="store">
						...
						<div>
							<table width="88%">
								<tr align="center">
									<td style="padding-right: 1cm; width: 15cm"><c:out
											value="${store.storeName}" /></td>
									<td style="padding-right: 1cm; width: 15cm"><c:out
											value="${store.regionName}" /></td>
									<td style="padding-right: 1cm; width: 15cm"><c:out
											value="${store.typeName}" /></td>
								</tr>
							</table>
						</div>
						...
						<div>
							...
							<p align="left">
								상점 위치:
								<c:out value="${store.regionName}" />
							</p>
							<p align="left">
								상점 업종:
								<c:out value="${store.typeName}" />
							</p>
							<p align="left">
								상점 전화번호:
								<c:out value="${store.storePhone}" />
							</p>
						</div>
