...
<div u="slides" style="cursor:move;position:absolute;left:260px;top:0px;width:720px;height:480px;overflow:hidden;">
	<c:set var="isExist1" value="false"></c:set>
	<c:forEach items="${events}" var="event" varStatus="status">
	<c:if test="${event.commentCode ne null }">
...
<div style="height:20px;"></div>
	<div>
			<!-- 바디 상점 검색 부분 시작 -->
			<div align="center"><br> <br> <br>	<h2 class="docs">검색결과</h2></div>
			...
			<div id="accordion-resizer" align="center"
				...
				<div id="accordion" style="font-family:'Jeju Gothic', serif; ">
					...
					<c:set var="isExist2" value="false"></c:set>
					<c:forEach items="${stores}" var="store">
					<c:if test="${store.storeCode ne null }">
