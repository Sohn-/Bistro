...
.scroll-bar-wrap .ui-slider-handle {
	...
	background: gray;
	border-color: gray;
/* 	background: rgba(255,125,175,1);
background: -moz-linear-gradient(left, rgba(255,125,175,1) 0%, rgba(255,125,175,1) 20%, rgba(245,124,103,1) 94%, rgba(245,124,103,1) 100%);
background: -webkit-gradient(left top, right top, color-stop(0%, rgba(255,125,175,1)), color-stop(20%, rgba(255,125,175,1)), color-stop(94%, rgba(245,124,103,1)), color-stop(100%, rgba(245,124,103,1)));
background: -webkit-linear-gradient(left, rgba(255,125,175,1) 0%, rgba(255,125,175,1) 20%, rgba(245,124,103,1) 94%, rgba(245,124,103,1) 100%);
background: -o-linear-gradient(left, rgba(255,125,175,1) 0%, rgba(255,125,175,1) 20%, rgba(245,124,103,1) 94%, rgba(245,124,103,1) 100%);
background: -ms-linear-gradient(left, rgba(255,125,175,1) 0%, rgba(255,125,175,1) 20%, rgba(245,124,103,1) 94%, rgba(245,124,103,1) 100%);
background: linear-gradient(to right, rgba(255,125,175,1) 0%, rgba(255,125,175,1) 20%, rgba(245,124,103,1) 94%, rgba(245,124,103,1) 100%);
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#ff7daf', endColorstr='#f57c67', GradientType=1 );
} */}
		...
		<section id="features" class="container"> <c:url
			...
			<ul>
				<li><a href=""><span>Region</span></a>
					<ul>
						<li>&nbsp; &nbsp;홍대 &nbsp; &nbsp; &nbsp; <input type="radio"
							name="regionName" value="홍대"></li>
						<li>&nbsp; &nbsp;강남 &nbsp; &nbsp; &nbsp;&nbsp;<input
							type="radio" name="regionName" value="강남"></li>
						<li>&nbsp; &nbsp;이태원 &nbsp;&nbsp;<input type="radio"
							name="regionName" value="이태원"></li>
						<li>&nbsp; &nbsp;건대 &nbsp; &nbsp; &nbsp; <input type="radio"
							name="regionName" value="건대"></li>
				...
				<li><a href=""><span>Type</span></a>
					<ul>
						<li>&nbsp; &nbsp;호프집 &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;<input
							type="radio" name="typeName" value="호프집"></li>
						<li>&nbsp; &nbsp;고기집 &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;<input
							type="radio" name="typeName" value="고기집"></li>
						<li>&nbsp; &nbsp;룸주점 &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;<input
							type="radio" name="typeName" value="룸주점"></li>
						<li>&nbsp; &nbsp;포장마차 &nbsp; &nbsp; <input type="radio"
							name="typeName" value="포장마차"></li>
						<li>&nbsp; &nbsp;일식 &nbsp; &nbsp;
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio"
							name="typeName" value="일식">
						</li>
					</ul></li>
				...
				<li><a href=""><span>Number</span></a>
					<ul>
						<li>&nbsp; &nbsp;4인이하&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; <input
							type="radio" name="number" value="4인이하"></li>
						<li>&nbsp; &nbsp;5~10인 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input
							type="radio" name="number" value="5~10인"></li>
						<li>&nbsp; &nbsp;10~20인 &nbsp; &nbsp; <input type="radio"
							name="number" value="10~20인"></li>
						<li>&nbsp; &nbsp;20인이상 &nbsp; &nbsp; <input type="radio"
							name="number" value="20인이상"></li>
					</ul></li>

				<li><a href=""><span>Service</span></a>
					<ul>
						<li>&nbsp; &nbsp;서비스추가 &nbsp; <input type="radio"
							name="serviceType" value="포장마차"></li>
						<li>&nbsp;
							&nbsp;할인&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input
							type="radio" name="serviceType" value="일식">
						</li>
					</ul></li>
