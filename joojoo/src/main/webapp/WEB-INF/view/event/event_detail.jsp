...
<body class="homepage" bgcolor=#333323>
	...
	<br><br>
		<h2>이벤트 글 상세 보기 여기에 원래 이벤트 글 제목이 들어가야 하나?ㅋㅋ??</h2> <br>		
		<c:out value="${eventDetail.title}"/>
		...
		<table  width="60%">
			<tr >
				...
				<img  src="images/pic01.jpg"  align="middle" > <br>
				</td>
				
				<td>
				<br> 오잉오잉 주주비어 3호점? <br>
					
				    <button type="button" class="btn btn-warning btn-sm">장바구니담기</button>
		...
		이벤트 상세내용이 포함됩니다 호호호<br>
		이벤트 상세내용이 포함됩니다 호호호<br>이벤트 상세내용이 포함됩니다 호호호<br>이벤트 상세내용이 포함됩니다 호호호<br>
		이벤트 상세내용이 포함됩니다 호호호<br>
		이벤트 상세내용이 포함됩니다 호호호<br>
		이벤트 상세내용이 포함됩니다 호호호<br>
		이벤트 상세내용이 포함됩니다 호호호<br>
